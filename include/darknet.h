...
LIB_API char *detection_to_json_with_image_dim(detection *dets, int nboxes, int classes, char **names, long long int frame_id, char *filename, long img_width, long img_height);
